...
function listOfNames(array) {
  ...
  for(let i = 0; i < artistsCopy.length; i++) {
    ...
    artistNames.push(artistsCopy[i]);
  }
    return artistNames;
}
listOfNames(artists);
...
addArtist(artists, "Ben Johnson", "1987", "Web Design", "American", "I worked in restaurants for 15 years. I am excited to get into coding!");
